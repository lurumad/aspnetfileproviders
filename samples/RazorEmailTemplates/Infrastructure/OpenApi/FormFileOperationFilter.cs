...
namespace RazorEmailTemplates.Infrastructure.OpenApi
{
            ...
            else
            {
                ...
                foreach (var parameter in containerParams)
                {
                    ...
                    paramsToRemove.AddRange(from p in parameters
                                            where p.Name.StartsWith(parameterFilter, StringComparison.InvariantCultureIgnoreCase)
                                            select p);
                }
                ...
                foreach (var parameter in containerParams)
                {
                    ...
                    {
                        var originalParameter = parameters.FirstOrDefault(param => param.Name.Equals(parameter.Name, StringComparison.InvariantCultureIgnoreCase));
